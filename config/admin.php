   ...
   */
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => Isifnet\PieAdmin\Models\Administrator::class,
            ],
        ],
    ...
    'grid' => [
        ...
        |--------------------------------------------------------------------------
        */
        'grid_action_class' => Isifnet\PieAdmin\Grid\Displayers\DropdownActions::class,
    ],
    ...
    */
    'database' => [
        ...
        'users_model' => Isifnet\PieAdmin\Models\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => Isifnet\PieAdmin\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => Isifnet\PieAdmin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => Isifnet\PieAdmin\Models\Menu::class,
    ...
    */
    ...
    |
    */
    'exception_handler' => Isifnet\PieAdmin\Exception\Handler::class,
